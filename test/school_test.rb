...
class SchoolTest < Minitest::Test
  ...
  def test_it_standardizes_student_names
    school = School.new('9.00', 7)
  ...
  def test_it_changes_pm_time_to_12_hr_clock
    school = School.new('9.00', 7)
  ...
  def test_it_changes_am_time_to_12_hr_clock
  ...
  def test_it_changes_noon_time_to_12_hr_clock
    school = School.new('9.00', 3)

    assert_equal '12:00', school.end_time
    assert_equal '12:00', school.convert_end_time_to_clock_time
